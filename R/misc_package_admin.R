...
## PACKAGE NAME        ##
#########################
#' simid.course.2019:  Material for SIMID course 2019
#
#' @author  Lander Willem [lander.willem@uantwerpen.be]
#' @docType package
#' @name simid.course.2019
#' @keywords internal
#'
...
# note: currently only on the system of the package administrator...
if(grepl('lwillem',getwd())){
